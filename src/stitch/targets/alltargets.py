...
from   stitch.steps.antcall import *
from   stitch.steps.enablecontrib import *
from   stitch.steps.execstep import *
from   stitch.steps.filesteps import *
from   stitch.steps.hadoopcomponent import *
from   stitch.steps.outputsteps import *
from   stitch.steps.raw import *
from   stitch.steps.rpmbuild import *
from   stitch.steps.step import *
from   stitch.steps.tar import *
...
from   stitch.targets.pythonredisttarget import *
from   stitch.targets.regproperty import *
from   stitch.targets.rsynctarget import *
from   stitch.targets.stepwise import *
...
class RawAntTarget(AntTarget):
  """ Injects raw user-specified XML into the build.xml file.
      ...
      buildXml          Opt - XML to include in Ant file for the 'build'
                              rule
      buildRuleName     Opt - If None (and buildXml is not None) stitch
                              will generate the <target> .. </target>
                              wrapper around the buildXml, using a
                              stitch-generated name. If this is set,
      ...
      stitch so that it can be reused and integrate with the rest of
